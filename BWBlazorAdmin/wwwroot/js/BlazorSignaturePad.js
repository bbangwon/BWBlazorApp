...
window.BlazorSignaturePad = function (id) {
    ...
    signaturePad.addEventListener("endStroke", () => {
        // .NET Function Call From Javascript
        document.getElementById("textSignature").value = signaturePad.toDataURL();
        DotNet.invokeMethodAsync("BWBlazorAdmin", "GetImageDataAsync", signaturePad.toDataURL());
        //
    });
}
